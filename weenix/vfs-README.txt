...
Ming-Yi Hsiao:
lookup(),dir_namev(),open_namev(),do_lseek,do_stat

Chieh-I Wu:
do_open(),do_read(),do_write(),do_close(),do_dup(),do_dup2(),do_mknod()

Yan-Ching Lin: 
do_rename(),do_chdir(),do_getdent(),

Chieh-Chun Chang:
do_mkdir(),do_rmdir(),do_unlink(),do_link(),special_file_read(),special_file_write()
